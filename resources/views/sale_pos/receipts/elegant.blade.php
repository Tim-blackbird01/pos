...
<div class="row invoice-info">
    ...
    <div class="col-md-6 invoice-col width-50 ">
        ...
        @if(!empty($receipt_details->logo))
            <img style="max-height: 130px; width: auto;" src="{{$receipt_details->logo}}" alt="Business logo" class="img center-block">
            <br/>
        @endif
        ...
        <table class="table table-bordered table-no-top-cell-border table-slim mb-12">
            <thead>
                <tr style="background-color: #357ca5 !important; color: white !important; font-size: 20px !important" class="table-no-side-cell-border table-no-top-cell-border text-center">
                    <th scope="col" style="background-color: #357ca5 !important; color: white !important; width: 5% !important">#</th>
                    ...
                    @if(!empty($receipt_details->discounted_unit_price_label))
                        ...
                        @endphp
                    @endif
                    <th scope="col" style="background-color: #357ca5 !important; color: white !important; width: {{$p_width}}% !important">
                        {{$receipt_details->table_product_label}}
                    </th>

                    @if($receipt_details->show_cat_code == 1)
                        <th scope="col" style="background-color: #357ca5 !important; color: white !important; width: 10% !important;">{{$receipt_details->cat_code_label}}</th>
                    @endif

                    <th scope="col" style="background-color: #357ca5 !important; color: white !important; width: 15% !important;">
                    ...
                    @if(!empty($receipt_details->discounted_unit_price_label))
                    <th scope="col" style="background-color: #357ca5 !important; color: white !important; width: 10% !important;">
