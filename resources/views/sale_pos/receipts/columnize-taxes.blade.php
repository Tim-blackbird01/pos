    ...
    <div class="col-md-6 invoice-col width-50 ">
        @if(empty($receipt_details->letter_head))
            ...
            @if(!empty($receipt_details->logo))
                <img style="max-height: 120px; width: auto;" src="{{$receipt_details->logo}}" alt="Business logo" class="img center-block">
                <br/>
            @endif
        ...
        <table class="table table-bordered table-no-top-cell-border table-slim">
            <thead>
                <tr style="background-color: #357ca5 !important; color: white !important; font-size: 15px !important font-weight: bold;" class="table-no-side-cell-border table-no-top-cell-border text-center">
                    <th scope="col" style="background-color: #357ca5 !important; color: white !important;">#</th>

                    <th scope="col" style="width: 30%; background-color: #357ca5 !important; color: white !important;" class="text-left">
                        {!! $receipt_details->table_product_label !!}
                    </th>

                    @if($receipt_details->show_cat_code == 1)
                        <th scope="col" style="background-color: #357ca5 !important; color: white !important;" class="text-right">{!! $receipt_details->cat_code_label !!}</th>
                    @endif

                    <th scope="col" style="background-color: #357ca5 !important; color: white !important;" class="text-right">
                    ...
                    <th scope="col" style="background-color: #357ca5 !important; color: white !important;">
                    ...
                    @if(!empty($receipt_details->table_tax_headings))
                        ...
                        @foreach($receipt_details->table_tax_headings as $tax_heading)
                            <th scope="col" style="background-color: #357ca5 !important; color: white !important;" class="word-wrap text-right">
            ...
            <tbody>
                @foreach($receipt_details->lines as $line)
                    <tr>
                        ...
                        <td class="text-left" style="word-break: break-all;">
                            @if(!empty($line['image']))
                                <img src="{{$line['image']}}" alt="Product" width="50" style="float: left; margin-right: 8px;">
                            @endif
                ...
                <tr>
                    ...
                    @if(!empty($receipt_details->item_discount_label))
                        ...
                        @endphp
                    @endif
                    <th scope="row" colspan="{{$colspan}}" class="text-right"
        ...
        @if($receipt_details->show_barcode || $receipt_details->show_qr_code)
            <div class="@if(!empty($receipt_details->footer_text)) col-xs-4 @else col-xs-12 @endif text-center">
                ...
                @if($receipt_details->show_barcode)
                    <img class="center-block" src="data:image/png;base64,{{DNS1D::getBarcodePNG($receipt_details->invoice_no, 'C128', 2,30,array(39, 48, 54), true)}}" alt="Barcode for invoice {{$receipt_details->invoice_no}}">
                @endif

                @if($receipt_details->show_qr_code && !empty($receipt_details->qr_code_text))
                    <img class="center-block mt-5" src="data:image/png;base64,{{DNS2D::getBarcodePNG($receipt_details->qr_code_text, 'QRCODE', 3, 3, [39, 48, 54])}}" alt="Receipt QR code">
                @endif
            </div>
        @endif
    </div>
