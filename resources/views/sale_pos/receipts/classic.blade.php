...
<div class="row receipt-reference-header" style="color: #000000 !important;">
        ...
        @if(empty($receipt_details->letter_head))
            @if(!empty($receipt_details->logo))
                <img style="max-height: 120px; width: auto;" src="{{$receipt_details->logo}}" alt="Business logo" class="img img-responsive center-block">
            @endif
...
<div class="row receipt-reference-footer" style="color: #000000 !important;">
    ...
    <div class="col-xs-12 receipt-barcode-block">
        <img class="center-block receipt-barcode" src="data:image/png;base64,{{DNS1D::getBarcodePNG($receipt_details->invoice_no, 'C128', 2,30,array(39, 48, 54), true)}}" alt="Barcode for invoice {{$receipt_details->invoice_no}}">
    </div>
