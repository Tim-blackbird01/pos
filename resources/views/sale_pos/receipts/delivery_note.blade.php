...
<div class="row invoice-info">
    ...
    <div class="col-md-6 invoice-col width-50 color-555">
        ...
        @if(!empty($receipt_details->logo))
            <img style="max-height: 120px; width: auto;" src="{{$receipt_details->logo}}" alt="Business logo" class="img">
            <br/>
        @endif
        ...
        <table class="table table-bordered table-no-top-cell-border">
            <thead>
                <tr style="background-color: #357ca5 !important; color: white !important; font-size: 20px !important" class="table-no-side-cell-border table-no-top-cell-border text-center">
                    ...
                    <th scope="col" style="background-color: #357ca5 !important; color: white !important; width: 65% !important">
                        {{$receipt_details->table_product_label}}
                    </th>

                    <th scope="col" style="background-color: #357ca5 !important; color: white !important; width: 30% !important;">
