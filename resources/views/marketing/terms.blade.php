...
.dark-sq{ position:absolute; border-radius:24px; border:1px solid rgba(255,255,255,0.12); background:rgba(255,255,255,0.04); pointer-events:none; }
.dark-sq-1{ width:420px; height:220px; bottom:8%; left:-5%; }
.dark-sq-2{ width:380px; height:200px; bottom:12%; right:18%; border-color: rgba(130,226,138,0.25); }
.dot-grid{ position:absolute; top:18%; right:12%; width:320px; height:320px; background-image: radial-gradient(rgba(82,194,109,0.4) 2px, transparent 2px); background-size:16px 16px; mask-image: radial-gradient(circle at center, black 40%, transparent 80%); -webkit-mask-image: radial-gradient(circle at center, black 40%, transparent 80%); opacity:0.7; pointer-events:none; }
...
.sidebar-toc{ position:sticky; top:100px; background:var(--card-bg); border:1px solid var(--border-color); border-radius:16px; padding:24px; box-shadow:0 10px 25px rgba(0,0,0,0.03); max-height:calc(100vh - 140px); overflow-y:auto; }
.toc-title{ font-size:14px; font-weight:700; text-transform:uppercase; letter-spacing:0.05em; color:var(--green-dark); margin-bottom:16px; display:flex; align-items:center; gap:8px; }
...
.toc-list a:hover{ background: rgba(72,169,107,0.1); color:var(--green-dark); padding-left:14px; }
.doc-content{ display:flex; flex-direction:column; gap:32px; }
.section-card{ background:var(--card-bg); border:1px solid var(--border-color); border-radius:20px; padding:36px; box-shadow:0 8px 30px rgba(0,0,0,0.03); transition: transform .2s ease, box-shadow .2s ease; scroll-margin-top:110px; }
...
.feature-grid{ display:grid; grid-template-columns: repeat(auto-fill, minmax(200px, 1fr)); gap:10px; margin-top:16px; }
.feature-item{ background:#ffffff; border:1px solid #d1fae5; padding:10px 14px; border-radius:12px; font-size:13px; font-weight:600; color:#065f46; display:flex; align-items:center; gap:8px; box-shadow:0 1px 2px rgba(0,0,0,0.02); }
.feature-item i{ color:var(--green-accent); }
.custom-list{ list-style:none; display:flex; flex-direction:column; gap:10px; margin-top:12px; }
.custom-list li{ position:relative; padding-left:28px; font-size:15px; color:var(--text-dark); }
.custom-list li::before{ content: none; position: absolute; left: 0; top: 2px; font-size: 14px; }
.custom-list.forbidden li::before{ content: none; }
.contact-box{ background: linear-gradient(135deg, var(--green-dark) 0%, var(--green-mid) 100%); color:#ffffff; padding:32px; border-radius:16px; margin-top:16px; }
            ...
            <main class="doc-content">
                ...
                <section id="sec-3" class="section-card">
                    ...
                    <div class="feature-grid">
                        <div class="feature-item"><i class="fas fa-cash-register"></i> Point of Sale</div>
                        <div class="feature-item"><i class="fas fa-boxes"></i> Inventory Management</div>
                        <div class="feature-item"><i class="fas fa-exchange-alt"></i> Stock Transfers</div>
                        <div class="feature-item"><i class="fas fa-store-alt"></i> Multi-Branch Management</div>
                        <div class="feature-item"><i class="fas fa-users-cog"></i> Employee Management</div>
                        <div class="feature-item"><i class="fas fa-address-book"></i> Customer Management</div>
                        <div class="feature-item"><i class="fas fa-truck-loading"></i> Supplier Management</div>
                        <div class="feature-item"><i class="fas fa-file-invoice"></i> Purchase Orders</div>
                        <div class="feature-item"><i class="fas fa-shopping-cart"></i> Sales Orders</div>
                        <div class="feature-item"><i class="fas fa-receipt"></i> Expense Tracking</div>
                        <div class="feature-item"><i class="fas fa-chart-line"></i> Financial Reports</div>
                        <div class="feature-item"><i class="fas fa-calculator"></i> Accounting</div>
                        <div class="feature-item"><i class="fas fa-barcode"></i> Barcode Generation</div>
                        <div class="feature-item"><i class="fas fa-print"></i> Receipt Printing</div>
                        <div class="feature-item"><i class="fas fa-percent"></i> Tax Management</div>
                        <div class="feature-item"><i class="fas fa-landmark"></i> KRA eTIMS Integration</div>
                        <div class="feature-item"><i class="fas fa-sms"></i> SMS Notifications</div>
                        <div class="feature-item"><i class="fas fa-envelope"></i> Email Notifications</div>
                        <div class="feature-item"><i class="fas fa-gift"></i> Loyalty Programs</div>
                        <div class="feature-item"><i class="fas fa-credit-card"></i> Gift Cards</div>
                        <div class="feature-item"><i class="fas fa-globe"></i> Online Ordering</div>
                        <div class="feature-item"><i class="fas fa-mobile-alt"></i> Mobile Applications</div>
                        <div class="feature-item"><i class="fas fa-wifi"></i> Offline Mode</div>
                        <div class="feature-item"><i class="fas fa-code"></i> APIs & Integrations</div>
                    </div>
                </section>
                ...
                <section id="sec-4" class="section-card">
                    ...
                    <p style="margin-top: 12px;">You must immediately notify us if unauthorized access occurs.</p>
                </section>
                ...
                <section id="sec-10" class="section-card">
                    ...
                    <p>Where enabled:</p>
                    <ul class="custom-list">
                        <li>We facilitate integration with Kenya Revenue Authority (KRA) systems.</li>
